...
class SecurityMiddleware {
    ...
    setupSecurityHeaders() {
        ...
        const cspDirectives = {
            defaultSrc: ["'self'"],
            scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://unpkg.com", "https://code.jquery.com", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://maxcdn.bootstrapcdn.com", "https://stackpath.bootstrapcdn.com", "https://kit.fontawesome.com", "https://static.cloudflareinsights.com", "https://dashboard.newstargeted.com"],
            styleSrc: ["'self'", "'unsafe-inline'", "https://unpkg.com", "https://fonts.googleapis.com", "https://cdnjs.cloudflare.com", "https://maxcdn.bootstrapcdn.com", "https://stackpath.bootstrapcdn.com", "https://use.fontawesome.com"],
            imgSrc: ["'self'", "data:", "https:", "https://cdn.discordapp.com"],
            connectSrc: ["'self'", "https://discord.com", "https://cdn.discordapp.com", "https://ka-f.fontawesome.com", "https://stats.g.doubleclick.net", "https://a.nel.cloudflare.com", "https://dashboard.newstargeted.com"],
            fontSrc: ["'self'", "data:", "https://unpkg.com", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com", "https://use.fontawesome.com", "https://ka-f.fontawesome.com"],
            objectSrc: ["'none'"],
            mediaSrc: ["'self'"],
            frameSrc: ["'none'"],
            baseUri: ["'self'"],
    ...
    shouldApplyHsts(req) {
        ...
        const firstValue = Array.isArray(forwardedProtoHeader)
