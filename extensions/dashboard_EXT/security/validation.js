...
class InputValidator {
    ...
    validateUsername(username) {
        ...
        if (sanitized.length < this.rules.username.minLength || 
            sanitized.length > this.rules.username.maxLength) {
            return { 
                valid: false, 
    ...
    validateCommandName(name) {
        ...
        if (sanitized.length < this.rules.commandName.minLength || 
            sanitized.length > this.rules.commandName.maxLength) {
            return { 
                valid: false, 
