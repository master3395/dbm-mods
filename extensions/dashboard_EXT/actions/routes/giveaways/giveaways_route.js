    ...
    init: async (DBM, Dashboard) => {
        ...
        Dashboard.app.put('/api/giveaways/:id', Dashboard.checkAuth, async (req, res) => {
            try {
                ...
                if (updateData.winnersThreadMessage !== undefined) giveaway.winnersThreadMessage = updateData.winnersThreadMessage;
                if (updateData.winnersThreadCloseDuration !== undefined) giveaway.winnersThreadCloseDuration = updateData.winnersThreadCloseDuration;
                if (updateData.winnerRoleRemoveDuration !== undefined) giveaway.winnerRoleRemoveDuration = updateData.winnerRoleRemoveDuration;
