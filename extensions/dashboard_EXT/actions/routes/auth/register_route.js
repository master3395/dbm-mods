...
module.exports = {
    ...
    handleRegister: async function(req, res, username, email, password, confirmPassword, discordId, cache) {
        try {
            // Validate input
    ...
    handleValidate: function(req, res, username, email, password, confirmPassword, cache) {
        try {
            const validation = this.validateRegistrationInput(username, email, password, confirmPassword);
    ...
    validateRegistrationInput: function(username, email, password, confirmPassword) {
        const errors = [];
